var app = (function () {
      ...
      (O = new Rt({})),
      {
        c() {
          ...
          (o = x()),
            ...
            (m = w("div")),
            (k = w("div")),
            (k.textContent = "Next WJSN song in:"),
            (b = x()),
            Q(S.$$.fragment),
            (D = x()),
            (T = w("div")),
  ...
  function an(e) {
    ...
    return {
      c() {
        (t = _("You got today's WJSN Heardle within the first ")),
          (n = _(s)),
          (r = _(" seconds."));
      },
      m(e, s) {
  ...
  function ln(e) {
    ...
    return {
      c() {
        (t = _("You got today's WJSN Heardle within ")),
          (n = _(o)),
          (r = _("\n                second")),
          (s = _(a)),
          (i = _("."));
    ...
    On = {
      subscribe: ue(
        [
          ...
          {
            url: "https://soundcloud.com/user-280075287/rewind-wjsn",
            answer: "Rewind - WJSN",
          },
          {
            url: "https://soundcloud.com/zonaostmp3/wjsn-super-moon",
            answer: "Super Moon - WJSN",
          },
          {
            url: "https://soundcloud.com/h3guvp54balf/tra-la-wjsn",
            answer: "Tra-la - WJSN",
          },
          {
    ...
    return {
      c() {
        (t = w("meta")),
          ...
          M(n, "sizes", "180x180"),
          M(n, "href", "https://cdn.glitch.global/9a8a7fbe-d03d-412a-b954-b60d271a3634/apple-touch-icon.png?v=1648526104246"),
          M(s, "rel", "icon"),
          M(s, "type", "image/png"),
          M(s, "sizes", "32x32"),
          M(s, "href", "https://cdn.glitch.global/9a8a7fbe-d03d-412a-b954-b60d271a3634/favicon-32x32.png?v=1648526061933"),
          M(i, "rel", "icon"),
          M(i, "type", "image/png"),
          M(i, "sizes", "16x16"),
          M(i, "href", "https://cdn.glitch.global/9a8a7fbe-d03d-412a-b954-b60d271a3634/favicon-16x16.png?v=1648526058665"),
          M(o, "rel", "manifest"),
